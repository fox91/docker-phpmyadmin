...
docker push docker.io/fox91/phpmyadmin:4.5.5-fpm
...
docker push docker.io/fox91/phpmyadmin:4.5.5-apache
# docker push docker.io/fox91/phpmyadmin:4.5-apache
docker push docker.io/fox91/phpmyadmin:apache

docker push docker.io/fox91/phpmyadmin:4.4.15.4-fpm
...
docker push docker.io/fox91/phpmyadmin:4.4.15.4-apache
